 ...
 //}
  function OnTimer(){ //get the date 
    ...
    am_pm = GetIni("am_pm");
     ...
     if (i == 1) {
        choice = document.getElementById("time_dropdown").value;
      }
      ...
      switch(choice){
        ...
        case "1":
         ...
         break;
        case "2":
         date = new Date().toLocaleString("en-US", {timeZone: "America/Winnipeg" });
         break;
        case "3":
         date = new Date().toLocaleString("en-US", {timeZone: "America/Edmonton" });
         break;
        case "4":
         date = new Date().toLocaleString("en-US", {timeZone: "America/Halifax" });
         break;
        case "5":
         date = new Date().toLocaleString("en-US", {timeZone: "America/St_Johns" });
         break;
         default:
         date = new Date().toLocaleString("en-US", {timeZone: "America/Toronto" });
         break;
